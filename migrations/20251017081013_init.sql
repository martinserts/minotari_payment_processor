...
-- Represents a single, atomic payment request from an external client.
...
-- Represents a group of payments that will be processed as a single on-chain transaction.
